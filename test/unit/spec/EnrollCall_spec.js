...
Expect.describe('EnrollCall', function() {
  ...
  const setupAndSendValidCode = _.partial(setupAndSendCode, resEnrollSuccess, 'US', '6501231234');

  const setupAndSendInvalidCode = _.partial(setupAndSendCode, resEnrollError, 'US', '650');
